namespace Loupedeck.AdaptiveRingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.AdaptiveRingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.AdaptiveRingPlugin.Resources.Resource.txt`.
